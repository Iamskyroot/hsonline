...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/src/main/resources/static/css/home_index.css">
    </head>
    <body>
        ...
        <ul class="navegacion" id="navegacion">
            ...
            <li class="n_item enlaces active"><a href="#">Principal</a></li>
            <li class="n_item enlaces"><a href="/src/main/resources/static/viwes/contacto.jsp">Contacto</a></li>
        ...
        <div class="main-content">
            ...
            <div class="mySlides fade">
                ...
                <img src="/src/main/resources/static/img/h_exterior2.jpg">
                <div class="text">Recepción. Parte exterior</div>
            </div>

            <div class="mySlides fade">
                <!-- <div class="numbertext">2 / 3</div> -->
                <img src="/src/main/resources/static/img/recepcion.jpg">
                <div class="text">Recepción. Parte interior</div>
            </div>

            <div class="mySlides fade">
                <!-- <div class="numbertext">3 / 3</div> -->
                <img src="/src/main/resources/static/img/pabellon.jpg">
            ...
            <div class="column main">
                <div class="portofollo">
                    ...
                    <div class="row">
                        <div class="column">
                            <div class="content">
                                <img src="/img/genicologia.png" alt="Genicologia" style="width:100%">
                                <h3>Genicologia</h3>
                        ...
                        <div class="column">
                            <div class="content">
                                <img src="/recursos/img/consulta.png" alt="Consulta" style="width:100%">
                        ...
                        <div class="column">
                            <div class="content">
                                <img src="/img/odontologia.jpeg" alt="Odontologia" style="width:100%">
                                <h3>Odontología</h3>
                        ...
                        <div class="column">
                            <div class="content">
                                <img src="/src/main/resources/static/img/consulta.png" alt="Mountains" style="width:100%">
                                <h3>Consulta</h3>
...
<script src="/src/main/resources/static//js/index.js" type="text/javascript"></script>
<script src="/src/main/resources/static/js/header.js" type="text/javascript"></script>
</body>
</html>